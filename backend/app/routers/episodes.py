...
async def create_episode(
    ...
    episode = DiagnosisEpisode(
        ...
        symptom_text_zh=body.symptom_text_zh,
        diagnosis=body.diagnosis,
        diagnosis_zh=body.diagnosis_zh,
        icd=body.icd,
        category=body.category,
        treatment=body.treatment,
        treatment_zh=body.treatment_zh,
        outcome=float(body.outcome),
        next_best_test=body.next_best_test,
        next_best_test_zh=body.next_best_test_zh,
        supporting=body.supporting,
        supporting_zh=body.supporting_zh,
        embedding=vec,
        source="captured",
        deidentified=True,
        snapshot_id=snap,
